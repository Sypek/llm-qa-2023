...
prompt_template = """
    ...
    If the AI does not know the answer to a question, it says: "I don't know the answer. It's possible that answer is not in the documentation."
    {context}

    Instruction: Based on the above documents, provide a detailed answer for this question: "{question}"
